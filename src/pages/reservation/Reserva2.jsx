          ...
          <div className="w-full  bg-white dark:bg-gray-700 dark:text-white flex flex-col justify-center py-10 px-4 rounded-xl drop-shadow-xl">
            ...
            <div className="basis-auto flex flex-row justify-center items-center gap-10 2xl:gap-20 font-semibold  dark:border-gray-700">
              ...
              <button
                ...
                className={
                  !flag
                    ? "text-center w-28 2xl:w-44 sm:w-36 flex flex-row items-center justify-center gap-2 h-[50%] px-4 py-2 2xl:px-12 hover:ring-2 dark:ring-gray-600 dark:bg-gray-700 bg-white dark:text-white text-black rounded-lg transform transition duration-100 hover:scale-105 ease-out bg- from-black to-purple-600 dark:from-black dark:to-gray-700 ring-purple-500 text-sm sm:text-base 2xl:text-lg m-4"
