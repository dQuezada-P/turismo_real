  ...
  if (departments.length == 0)
    return (
      <div className=" h-full relative z-30">
        ...
        />
        <h2 className="text-4xl text-center text-purple-800 underline decoration-black min-h-screen mt-40">No HAY Departamentos Disponbles</h2>
      </div>
    );
