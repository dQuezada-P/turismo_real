...
export const ModalInfo = ({
  params: { success, title, message, redirect_to },
}) => {
  ...
  return (
    <div className="fixed w-full h-screen bg-black/[.8] z-50">
      <Modal show={true} size="lg" popup={true} onClose={onCloseModal}>
        <Modal.Header><p className="font-semibold text-xl">{title}</p></Modal.Header>
        <Modal.Body>
          <div className="relative w-auto my-6 mx-auto max-w-sm sm:max-w-md 2xl:max-w-2xl font-semibold">
            <div
              className={
                success
